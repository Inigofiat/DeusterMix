...
public class ControllerLibroTest {
    ...
    @Test
    public void testCrearLibro_InvalidToken() {
        String tokenUsuario = "invalidToken";
        LibroDTO libroDTO = new LibroDTO(null, "Nuevo Libro", "ISBN123", 9.99, Arrays.asList(1L, 2L), null);
        ...
        verify(authService, times(1)).esTokenValido(tokenUsuario);
        verify(serviceLibro, never()).crearLibro(any(), any());
    }
